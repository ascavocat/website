...
function go(url){
  document.getElementById('JotFormIFrame-231435627732254').src= url;
}
...
if (lang=== "fr"){
  go('https://form.jotform.com/231435627732254?language=fr-CA&dropdown=hidden') ;

} else if (lang=== "en"){
  go('https://form.jotform.com/231435627732254?language=en-CA&dropdown=hidden') ;
}  
